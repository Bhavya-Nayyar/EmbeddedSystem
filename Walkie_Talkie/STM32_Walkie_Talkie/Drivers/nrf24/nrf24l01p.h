...
#define NRF24L01P_SPI_CS_PIN_NUMBER GPIO_PIN_5

#define NRF24L01P_CE_PIN_PORT GPIOB
#define NRF24L01P_CE_PIN_NUMBER GPIO_PIN_6

/*
 * IRQ is NOT connected in this project.
 * We will poll STATUS.RX_DR instead.
 */
...
typedef enum { _250kbps = 2, _1Mbps = 0, _2Mbps = 1 } air_data_rate;

typedef enum { _0dBm = 3, _6dBm = 2, _12dBm = 1, _18dBm = 0 } output_power;
